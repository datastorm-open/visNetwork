...
#' @param edgesFontAlign \code{character}, for edges only. Default tp 'horizontal'. Possible options: 'horizontal' (Default),'top','middle','bottom'. See  \link[visNetwork]{visEdges}  
...
#' @param legend \code{boolean}, add legend ? Default TRUE.  \link[visNetwork]{visLegend}
...
#' @param shapeVar \code{character}, shape for variables nodes See  \link[visNetwork]{visNodes}
#' @param shapeY \code{character}, shape for terminal nodes See  \link[visNetwork]{visNodes}
#' @param export \code{boolean}, add export button. Default to TRUE
#' 
#' @return a visNetwork object 
#' 
#' @seealso  \link[visNetwork]{visTreeEditor},  \link[visNetwork]{visTreeModuleServer},  \link[visNetwork]{visNetworkEditor}
#'
...
#' @param  ...  all arguments except \code{object} present in  \link[visNetwork]{visTreeModuleServer}
#' 
#' @examples
#' 
#' \dontrun{
...
#' 
#' @seealso  \link[visNetwork]{visTree},  \link[visNetwork]{visTreeModuleServer},  \link[visNetwork]{visNetworkEditor}
#'
#' @references See online documentation \url{https://datastorm-open.github.io/visNetwork/}
#'
