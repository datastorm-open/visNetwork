...
#'}
#'@param selectedBy : Custom option. Character or a named list. Add a multiple selection based on column of node data.frame.
#'\itemize{
...
visOptions <- function(graph,
  ...
  x <- list(highlight = highlightNearest, degree = degree, idselection = idselection, byselection = byselection)
