...
#' @param hierarchical : Boolean. Default to false. When true, the layout engine positions the nodes in a hierarchical fashion using default settings. For customization you can use \link[pkg:visNetwork]{visHierarchicalLayout}
#'
#' @examples
#'
