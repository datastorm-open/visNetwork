...
Legend is, for moment, only available if you are using group configuration.
...
With *visNetworkOutput* and *renderVisNetwork*. Using with shiny, and enabled options *nodesIdSelection*, you can access to new input with current selection value :
